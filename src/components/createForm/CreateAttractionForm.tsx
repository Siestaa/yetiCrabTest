...
import {Attraction, IFormData, ILocationMarker} from '@/types/attraction';
...
const Map = dynamic<ILocationMarker>(() => import('../Map/Map').then((mod) => mod.Map), {
    ssr: false,
});
...
export const CreateAttractionForm = ({attraction}: CreateAttractionFormProps) => {
    ...
    const saveAttraction = async (attractionData: Attraction, attractionId?: string) => {
        if (attractionId) {
