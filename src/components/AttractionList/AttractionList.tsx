		...
		<div className={styles.listContainer}>
			...
			{isAdmin && (
				<Button
					view="action"
					size="l"
					onClick={() => router.push('/createAttraction')}
				>
					Создать карточку
				</Button>
			)}
			...
			<div className={styles.sortButtons}>
				...
				>
					Название {sortConfig.key === 'title' && (sortConfig.direction === 'up' ? '↑' : '↓')}
				</Button>
				<Button
					view="outlined"
					size="m"
				...
				>
					Рейтинг {sortConfig.key === 'rating' && (sortConfig.direction === 'up' ? '↑' : '↓')}
				</Button>
				<Button
					view="outlined"
					size="m"
				...
				>
					Местоположение {sortConfig.key === 'location' && (sortConfig.direction === 'up' ? '↑' : '↓')}
				</Button>
			</div>
